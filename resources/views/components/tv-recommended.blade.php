<div class="tv-list ml-0 sm:ml-0 md:ml-24 mt-12 glide__now__playing relative">
    <div class="tv-heading"><h4 class="tracking-widest font-medium text-xl">LATEST</h4></div>
    <div class="flex glide__track" data-glide-el="track">
        <ul class="glide__slides scrolling-auto overflow-visible">
        @foreach ($latestTv as $tvshow)

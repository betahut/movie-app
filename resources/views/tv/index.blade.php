...
@section('content')
    <div class="mx-auto bg-gray-900">
        <div class="content">
            <div class="hero-image absolute h-screen bg-cover bg-center container" style="background-image:linear-gradient(to bottom, rgba(255, 255, 255, 0), rgba(26, 32, 44) 85%), url({{ $topRatedTv[0]['backdrop_path'] }}); background-size: cover;"></div>
...
@section('scripts')
    ...
    <script>
        if(document.querySelector('.glide__featured .glide__track')){
            ...
            let featuredBgIamge = () => {
                let activeBgImage = document.querySelector('.glide__featured .glide__slide--active .tvshow-back-drop').innerText;

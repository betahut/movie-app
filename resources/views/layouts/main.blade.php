...
<body class="container mx-auto font-sans text-white relative" style="background:linear-gradient(to bottom, rgba(26, 32, 44, 0.925), rgba(26, 32, 44) 65%) no-repeat;">
    <nav class="fixed bottom-0 sm:bottom-0 md:bottom-auto left-0 sm:left-0 md:left-auto h-24 md:h-screen w-full sm:w-full md:w-24 flex justify-between  items-center flex-row md:flex-col bg-gray-900 z-50 border-t md:border-t-0 border-r-0 md:border-r border-gray-800">
        ...
        <ul class="nav-items flex flex-row md:flex-col items-center">
            <li class="mx-4 my-2 sm:mx-4 sm:my-2 md:mx-8 md:my-4"><a href="#"><img class="w-8 sm:w-8 md:w-32" src="/images/003-search.svg" alt="" /></a></li>
    ...
    <footer class="px-8 md:px-32 py-8 flex flex-col md:flex-row justify-between items-end mb-24 md:mb-0">
        <div class="">
            ...
            <div class="mt-4 flex">
                <input type="text" class="p-2 border border-grey-700 round text-grey-dark text-sm h-auto" placeholder="Your email address">
                <button class="bg-gray-700 border-grey-700 text-white rounded-sm h-auto text-xs p-3">Subscribe</button>
            </div>
